...
enyo.kind({
  ...
  components: [
	  {kind: enyo.Header, content: "Tetris for WebOS 0.1"},
	  {kind: "Image", src: "images/tetris-original.jpg", style: "height: 760px; z-index: -5"},
	  {kind: enyo.VFlexBox, style: "position: absolute; top: 380px; left: 390px;width: 250px", components: [
		 {kind: enyo.Button, caption: "Nová hra", onclick: "startGame"},
		 {kind: enyo.Button, caption: "High score", onclick: "showHighScore"},
		 {kind: enyo.Button, caption: "Autoři"},
